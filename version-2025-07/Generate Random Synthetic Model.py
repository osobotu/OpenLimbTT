...
component[0] = random.choice(np.linspace(-17.04, 24.25, 100))
component[1] = random.choice(np.linspace(-10.38 , 16.42, 100))
component[2] = random.choice(np.linspace(-8.41, 10.04, 100))
component[3] = random.choice(np.linspace(-6.42, 11.66, 100))
component[4] = random.choice(np.linspace(-4.73 , 5.21, 100))
component[5] = random.choice(np.linspace(-4/3 , 4.38, 100))
component[6] = random.choice(np.linspace(-4.01 , 4.01, 100))
component[7] = random.choice(np.linspace(-2.55, 2.68, 100))
component[8] = random.choice(np.linspace(-2.26, 2.5, 100))
component[9] = random.choice(np.linspace(-1.97 , 2.49, 100))
component[10] = random.choice(np.linspace(-1.54, 2.2, 100))
component[11] = random.choice(np.linspace(-0.96 , 2.48, 100))
component[12] = random.choice(np.linspace(-1.46, 2.49, 100))
component[13] = random.choice(np.linspace(-0.96, 1.66, 100))
component[14] = random.choice(np.linspace(-1.12, 1.65, 100))
component[15] = random.choice(np.linspace(-0.95, 1.14, 100))
component[16] = random.choice(np.linspace(-0.9 , 0.97, 100))
component[17] = random.choice(np.linspace(-0.7, 0.83, 100))
component[18] = random.choice(np.linspace(-0.66 , 1.23, 100))
component[19] = random.choice(np.linspace(-0.49, 0.96, 100))
component[20] = random.choice(np.linspace(-0.62 , 0.73, 100))
component[21] = random.choice(np.linspace(-0.53 , 0.69, 100))
component[22] = random.choice(np.linspace(-0.61 , 0.75, 100))
component[23] = random.choice(np.linspace(-0.45, 0.54, 100))
component[24] = random.choice(np.linspace(-0.37 , 0.5, 100))
component[25] = random.choice(np.linspace(-0.46 , 0.5, 100))
component[26] = random.choice(np.linspace(-0.39 , 0.46, 100))
component[27] = random.choice(np.linspace(-0.32, 0.42, 100))
component[28] = random.choice(np.linspace(-0.28 , 0.35, 100))
component[29] = random.choice(np.linspace(-0.32 , 0.32, 100))
component[30] = random.choice(np.linspace(-0.22, 0.26, 100))
component[31] = random.choice(np.linspace(-0.22, 0.37, 100))
